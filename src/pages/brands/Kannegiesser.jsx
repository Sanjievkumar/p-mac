...
// Asset Imports
import heroBg from '../../assets/brands/kannegiesser/kannegiesser_hero_1780671024936.png';
      ...
      <section className="relative w-full h-[90vh] min-h-[600px] flex flex-col justify-center overflow-hidden">
        ...
        <div className="absolute top-32 left-0 w-full px-8 md:px-16 flex justify-between items-center z-20">
          ...
          <div className="flex items-center gap-3">
            <span className="text-white text-sm tracking-widest font-medium opacity-80 uppercase">
        ...
        <div className="relative z-20 max-w-7xl w-full mx-auto px-8 md:px-16 mt-20">
          <motion.h1 
            ...
            className="text-white text-5xl md:text-6xl lg:text-7xl font-black leading-[1.1] tracking-tight mb-8 max-w-3xl"
          >
          ...
          <motion.p 
            ...
            className="text-white/80 text-lg md:text-xl font-light mb-12 max-w-md leading-relaxed"
          >
          ...
          <motion.button 
            ...
            className="group flex items-center gap-4 text-white hover:text-[#E31E24] transition-colors duration-300"
          >
            <div className="w-12 h-12 rounded-full border-2 border-current flex items-center justify-center transition-transform duration-300 group-hover:scale-110">
